...
G1_2 = ox.graph_from_point(location_point, dist=2000, dist_type='bbox', network_type='walk')

route = nx.shortest_path(G1_2, list(G1_2)[2], list(G1_2)[2], weight='length')
print(route)
print(list(G1_2)[2])
# fig, ax = ox.plot_graph_route(G1_2, list(G1_2)[0], node_size=0)
